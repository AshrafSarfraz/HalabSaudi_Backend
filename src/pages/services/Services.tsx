    ...
    <Layout>
      <div className="container mx-auto py-4">
        ...
        <div className="bg-white shadow-md rounded-md p-4">
          <h3 className="text-xl font-semibold mb-4">Venus List</h3>
          <table className="w-full border-collapse border border-gray-200">
            ...
            <tbody>
              ...
              )) : <tr><td colSpan={4} className="text-center py-4">No Item found.</td></tr>}
            </tbody>
          </table>
        </div>

        <ServicesModal open={openModal} onClose={() => setOpenModal(false)} venusName={venusName} logo={logo} status={status} 
